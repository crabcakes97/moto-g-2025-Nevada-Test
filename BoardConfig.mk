...
# Partitions LAME SHIT THAT MAKES TWRP WORK
BOARD_FLASH_BLOCK_SIZE := 262144 # (BOARD_KERNEL_PAGESIZE * 64)
BOARD_VENDOR_BOOTIMAGE_PARTITION_SIZE := 67108864
BOARD_HAS_LARGE_FILESYSTEM := true

# filesystem YOOOOOOOO
...
# Platform PROBALY MORE IMPORTANT SHIIIIIII
TARGET_BOARD_PLATFORM := mt6835

# TWRP Configurations CONFIG CRAP
TW_FRAMERATE := 90
...
#Brightness ITS THE SUN
TW_BRIGHTNESS_PATH := "/sys/class/leds/lcd-backlight/brightness"
TW_DEFAULT_BRIGHTNESS := 1400
TW_MAX_BRIGHTNESS := 2048

# USB IDK WHAT TO PUT HERE
TW_EXCLUDE_DEFAULT_USB_INIT := true
#TARGET_USE_CUSTOM_LUN_FILE_PATH := /config/usb_gadget/g1/functions/mass_storage.usb0/lun.%d/file

# Haptics MAKES PHONE GO BRRRRRRRRR
TW_SUPPORT_INPUT_AIDL_HAPTICS := true
TW_SUPPORT_INPUT_AIDL_HAPTICS_FIX_OFF := true

# Storage SHIIT NOT A SHED
RECOVERY_SDCARD_ON_DATA := true

# Temp COOKED ON FIRE
TW_CUSTOM_CPU_TEMP_PATH := sys/devices/virtual/thermal/thermal_zone50/temp

# Modules LAME IMPORTANT SHIT
TW_LOAD_VENDOR_BOOT_MODULES := true
TW_LOAD_VENDOR_MODULES = false
TW_SKIP_ADDITIONAL_FSTAB := true

#Screen Resolution/Flashlight
